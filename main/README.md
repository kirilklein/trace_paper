...
- `volcano_plot_tmle_ipw_overlay_{effect_type}.png` - TMLE vs IPW overlay comparison
- `confusion_matrix_{effect_type}.png` - Significance agreement heatmap

### Interactive Figures (Plotly)

- `volcano_plot_{effect_type}_interactive.html` - Interactive main volcano plot
